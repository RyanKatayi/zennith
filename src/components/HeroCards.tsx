    ...
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[700px] h-[500px]">
      ...
      <Card className="absolute w-[340px] -top-[15px] drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        <CardHeader className="flex flex-row items-center gap-4 pb-2 ">
          <Avatar>
            <AvatarImage
              alt=""
              src="https://pbs.twimg.com/profile_images/1729919168709808128/XZwJdK69_400x400.jpg"
            />
            <AvatarFallback>MM</AvatarFallback>
          </Avatar>

          <div className="flex flex-col">
            <CardTitle className="text-lg">Munya  Makosa</CardTitle>
            <CardDescription>
              <a href="https://twitter.com/makosamunyaa" target="_blank" rel="noopener noreferrer">@makosamunyaa</a>
            </CardDescription>
          </div>
        </CardHeader>
      ...
      <Card className="absolute right-[20px] top-4 w-80 flex flex-col justify-center items-center drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        <CardHeader className="mt-8 flex justify-center items-center pb-2">
          <img
            src="https://pbs.twimg.com/profile_images/1774033354431623168/46g9xRYn_400x400.jpg"
            alt="user avatar"
            className="absolute grayscale-[0%] -top-12 rounded-full w-24 h-24 aspect-square object-cover"
          />
          <CardTitle className="text-center">Ryan Katayi</CardTitle>
